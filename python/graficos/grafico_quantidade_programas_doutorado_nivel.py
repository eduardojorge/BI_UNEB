#Qunatidade de Programas de Doutorado  por Nível  2020 
...
cursor.execute("SELECT D_POS_MODALIDADE, D_TIPO_POS_NOME,  QTD, NIVEL"+
               " FROM  CUBO_POS_PROGRAMA_MODALIDADE where D_SEM_CODIGO=? AND D_TIPO_POS_NOME IN ('DOUTORADO',"+
               " 'DOUTORADO PROFISSIONAL')", (D_SEM_CODIGO,) )
total=0;
quantidade =[]
labels=[]
linha= ""
...
plt.title("Qunatidade de Programas de Doutorado  por Nível  2020 Total="+str(total) +" (fonte Capes)");
